    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">便捷外卖点餐系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        -->
                        <!--
                            <el-form-item label="工作时间" class="input" v-if="tableName=='shangjia'">
                                <el-input v-model="ruleForm.shangjiaGongzuoshijian" autocomplete="off" placeholder="工作时间"  />
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="配送范围" class="input" v-if="tableName=='shangjia'">
                                <el-input v-model="ruleForm.shangjiaPeisongfanwei" autocomplete="off" placeholder="配送范围"  />
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="主营项目" class="input" v-if="tableName=='shangjia'">
                                <el-input v-model="ruleForm.shangjiaZhuying" autocomplete="off" placeholder="主营项目"  />
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="店铺位置" class="input" v-if="tableName=='shangjia'">
                                <el-input v-model="ruleForm.shangjiaAdress" autocomplete="off" placeholder="店铺位置"  />
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="信用等级" class="input" v-if="tableName=='shangjia'">
                                <el-input v-model="ruleForm.shangjiaXingjiTypes" autocomplete="off" placeholder="信用等级"  />
                           </el-form-item>
                        -->
                        <!--
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            //     return
                            // }
                            // shangjia 中的 工作时间 判空处理
                            // if('shangjia' == this.tableName && (this.ruleForm.shangjiaGongzuoshijian== null ||this.ruleForm.shangjiaGongzuoshijian== "")){
                            //     this.$message.error("工作时间不能为空");
                            //     return
                            // }
                            // shangjia 中的 配送范围 判空处理
                            // if('shangjia' == this.tableName && (this.ruleForm.shangjiaPeisongfanwei== null ||this.ruleForm.shangjiaPeisongfanwei== "")){
                            //     this.$message.error("配送范围不能为空");
                            //     return
                            // }
                            // shangjia 中的 主营项目 判空处理
                            // if('shangjia' == this.tableName && (this.ruleForm.shangjiaZhuying== null ||this.ruleForm.shangjiaZhuying== "")){
                            //     this.$message.error("主营项目不能为空");
                            //     return
                            // }
                            // shangjia 中的 店铺位置 判空处理
                            // if('shangjia' == this.tableName && (this.ruleForm.shangjiaAdress== null ||this.ruleForm.shangjiaAdress== "")){
                            //     this.$message.error("店铺位置不能为空");
                            //     return
                            // }
                            // shangjia 中的 信用等级 判空处理
                            // if('shangjia' == this.tableName && (this.ruleForm.shangjiaXingjiTypes== null ||this.ruleForm.shangjiaXingjiTypes== "")){
                            //     this.$message.error("信用等级不能为空");
                            //     return
                            // }
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/bianjiewaimai/img/back-img-bg.jpg);
