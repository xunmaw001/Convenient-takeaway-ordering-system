        ...
        <div v-if="showFlag">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/bianjiewaimai/upload/shangjiaMuBan.xls"
                        >批量导入商家数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('shangjia','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="shangjiaGongzuoshijian"
                                   header-align="center"
                                   label="工作时间">
                        <template slot-scope="scope">
                            {{scope.row.shangjiaGongzuoshijian}}
                        </template>
                    </el-table-column>

                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="shangjiaPeisongfanwei"
                                   header-align="center"
                                   label="配送范围">
                        <template slot-scope="scope">
                            {{scope.row.shangjiaPeisongfanwei}}
                        </template>
                    </el-table-column>

                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="shangjiaZhuying"
                                   header-align="center"
                                   label="主营项目">
                        <template slot-scope="scope">
                            {{scope.row.shangjiaZhuying}}
                        </template>
                    </el-table-column>
...
<script>
    ...
    //当前表下拉框搜索条件
            form:{
                ...
                shangjiaEmail : null,
                shangjiaPhoto : null,
                shangjiaGongzuoshijian : null,
                shangjiaPeisongfanwei : null,
                shangjiaZhuying : null,
                shangjiaAdress : null,
            ...
            json_fields: {
                ...
                //本表字段
                     ...
                     '工作时间': "shangjiaGongzuoshijian",
                     '配送范围': "shangjiaPeisongfanwei",
                     '主营项目': "shangjiaZhuying",
                     '店铺位置': "shangjiaAdress",
                     '信用等级': "shangjiaXingjiValue",
                     '现有余额': "newMoney",
            },
