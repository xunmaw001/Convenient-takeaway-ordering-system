  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='shangjia'"  label='工作时间' prop="shangjiaGongzuoshijian">
               <el-input v-model="ruleForm.shangjiaGongzuoshijian"  placeholder='工作时间' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='shangjia'"  label='配送范围' prop="shangjiaPeisongfanwei">
               <el-input v-model="ruleForm.shangjiaPeisongfanwei"  placeholder='配送范围' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='shangjia'"  label='主营项目' prop="shangjiaZhuying">
               <el-input v-model="ruleForm.shangjiaZhuying"  placeholder='主营项目' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='shangjia'"  label='店铺位置' prop="shangjiaAdress">
               <el-input v-model="ruleForm.shangjiaAdress"  placeholder='店铺位置' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='shangjia'"  label='信用等级' prop="shangjiaXingjiTypes">
                 <el-select v-model="ruleForm.shangjiaXingjiTypes" disabled placeholder='请选择信用等级'>
                     <el-option
...
// 注册表 商家 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.shangjiaGongzuoshijian)&& 'shangjia'==this.flag){
                             this.$message.error('工作时间不能为空');
                             return
                         }

                         if((!this.ruleForm.shangjiaPeisongfanwei)&& 'shangjia'==this.flag){
                             this.$message.error('配送范围不能为空');
                             return
                         }

                         if((!this.ruleForm.shangjiaZhuying)&& 'shangjia'==this.flag){
                             this.$message.error('主营项目不能为空');
                             return
                         }

                         if((!this.ruleForm.shangjiaAdress)&& 'shangjia'==this.flag){
