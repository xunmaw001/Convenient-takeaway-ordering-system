...
//                            shangjiaEntity.setShangjiaGongzuoshijian(data.get(0));                    //工作时间 要改的
//                            shangjiaEntity.setShangjiaPeisongfanwei(data.get(0));                    //配送范围 要改的
//                            shangjiaEntity.setShangjiaZhuying(data.get(0));                    //主营项目 要改的
//                            shangjiaEntity.setShangjiaAdress(data.get(0));                    //店铺位置 要改的
//                            shangjiaEntity.setShangjiaXingjiTypes(Integer.valueOf(data.get(0)));   //信用等级 要改的
