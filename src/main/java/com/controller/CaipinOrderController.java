    ...
    */
    ...
    public R add(@RequestBody CaipinOrderEntity caipinOrder, HttpServletRequest request){
        logger.debug("add方法:,,Controller:{},,caipinOrder:{}",this.getClass().getName(),caipinOrder.toString());
            ...
            ShangjiaEntity shangjiaEntity = shangjiaService.selectById(caipinEntity.getShangjiaId());
            shangjiaEntity.setNewMoney(shangjiaEntity.getNewMoney()+caipinOrder.getCaipinOrderTruePrice());//动态计算金额
